<%@ page import="com.app.entity.ReportedQuestion" %>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item" href="#" style="opacity: .3;">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Reported Question</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
               <input type="submit" class="btn btn-primary" value="Delete Question"/>
            </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <%
                    if(request.getAttribute("reportedQuestions")!=null){
                      ArrayList<ReportedQuestion> reportedQuestions = (ArrayList)request.getAttribute("reportedQuestions");
                      for(ReportedQuestion reportedQuestion: reportedQuestions) {
                        out.println("<tr>");
                        out.println("<td><input type=\"checkbox\" name=\"reportedQuestionSelection\" value=\"" + reportedQuestion.getQuestionID() + "\"/>&nbsp;</td>");
                        out.println("<td>" + reportedQuestion.getQuestionID() + "</td>");
                        out.println("<td>" + reportedQuestion.getTitle() + "</td>");
                        out.println("<td>" + reportedQuestion.getDescription() + "</td>");
                        out.println("<td>" + reportedQuestion.getReportedIssue() + "</td>");
                        out.println("</tr>");
                      }
                    }
                  %>
